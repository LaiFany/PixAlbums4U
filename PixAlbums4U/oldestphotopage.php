		...
		<section class = "usermainpage-section">
         ...
         <div class="col-md-8">
				...
				<?php
					...
					$query = mysqli_query($mysqli,"SELECT id, url, description, member_id, album_id, name FROM image ORDER BY date_time_created");
					if(empty($query)){
						...
						while($run = mysqli_fetch_array($query)){
							...
							<div id = "usermainpage-images">
									...
									<div id = "bottomimageinfo">
										<div class = "imagename">
											<a href = "photopagebyoldest.php?id=<?php echo $image_id;?>"><?php echo $name ; ?></a>
										</div>
										<div class = "imagedesc">
